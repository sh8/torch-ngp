...
class Trainer(_Trainer):
    ...
    def __init__(
        ...
        super().__init__(name, opt, model, criterion, optimizer, ema_decay,
                         lr_scheduler, metrics, local_rank, world_size, device,
                         mute, fp16, eval_interval, max_keep_ckpt, workspace,
                         best_mode, use_loss_as_metric, report_metric_at_train,
                         use_checkpoint, use_tensorboardX,
    ...
    def train_one_epoch(self, loader):
        ...
        for data in loader:
            ...
            if self.global_step in self.opt.upsample_model_steps:
                ...
                self.log(
                    f"[INFO] upsample model at step {self.global_step} from {self.model.resolution[0]} to {reso}"
                )
    ...
    def load_checkpoint(self, checkpoint=None, model_only=False):
        ...
        self.model.upsample_model(
            checkpoint_dict['resolution'])  # Different from _Trainer!
